...
@Service
class ProductCharacteristicService(repository: ProductCharacteristicRepository) : BaseCharacteristicService<ProductCharacteristic, ProductCharacteristicRepository>(repository)