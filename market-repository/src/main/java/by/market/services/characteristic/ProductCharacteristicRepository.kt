...
@Repository
interface ProductCharacteristicRepository : BaseRepository<ProductCharacteristic> {
    fun existsByTitleAndDataType(title: String, dataType: DataType): Boolean
    fun findByTitleAndDataType(title: String, dataType: DataType): ProductCharacteristic
}
